...
public class HeroRepository {
	...
	return (Hero) namedParameterJdbcTemplate.queryForObject(FIND_HERO_ID_QUERY, params,
	...
	return namedParameterJdbcTemplate.query(FIND_HERO_NAME_QUERY, params,
		new BeanPropertyRowMapper<Hero>(Hero.class));
    };

    int updateHero(Hero hero) {
	final Map<String, Object> params = Map.of("id", hero.getId(), "name", hero.getName(), "race",
		hero.getRace().name(), "powerStatsId", hero.getPowerStatsId());
